...
#include "UITiledMap.h"

cocos2d::TMXTiledMap* UITiledMap::create(std::string tmxFile)
{
...
void UITiledMap::createTMXTiled(cocos2d::TMXTiledMap* tmxTiledMap)
{
