...
UISlider UISlider::createTSlider(std::string text)
{
    cocos2d::ui::Slider* slider = cocos2d::ui::Slider::create();
    slider->setName(text);
    slider->loadBarTexture("UI/Slider/Slider_Back.png");
    slider->loadSlidBallTextures("UI/Slider/SliderNode_Normal.png",
                                 "UI/Slider/SliderNode_Press.png",
    ...
    slider->addEventListener([](cocos2d::Ref* ptr, cocos2d::ui::Slider::EventType eventType)
                             {
                                 ...
                                 switch (eventType)
                                 {
                                     ...
                                     case cocos2d::ui::Slider::EventType::ON_PERCENTAGE_CHANGED:
                                         cocos2d::log("Slider(%s): ON_PERCENTAGE_CHANGED: %i", slider->getName().c_str(),
                                             slider->getPercent());
                                         break;
...
//cocos2d::Vector<UISlider>* UISlider::create(std::vector vector)
//{
//    cocos2d::log("%i", vector.size());
//
//    cocos2d::Vector<UISlider>* vec;
//
//    int       count = 0;
//    for (auto v : vector)
//    {
